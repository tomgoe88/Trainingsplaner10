 ...
 */
public class ListAdapterBeine extends BaseAdapter implements AdapterView.OnItemClickListener {

     List<Beine> uebung;
    private FragmentActivity context;
    Trainingsplaner trainingsplaner;
    public ListAdapterBeine(FragmentActivity con, List<Beine> ueb, Trainingsplaner trainingsplaner){
        this.context= con;
        this.uebung=ueb;
