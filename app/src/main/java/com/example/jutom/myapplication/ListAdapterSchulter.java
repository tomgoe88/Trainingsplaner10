 ...
 */
public class ListAdapterSchulter extends BaseAdapter implements AdapterView.OnItemClickListener{

     List<Schulter> uebung;
    private FragmentActivity context;
    Trainingsplaner trainingsplaner;
    public ListAdapterSchulter(FragmentActivity con, List<Schulter> ueb,Trainingsplaner trainingsplaner){
        this.context= con;
        this.uebung=ueb;
