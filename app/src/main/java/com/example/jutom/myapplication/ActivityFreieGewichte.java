...
public class ActivityFreieGewichte extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_freie_gewichte);
        ...
        ft.add(R.id.freieFrame, new FragmentFreieGewichte());
        ft.commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_freie_gewichte, menu);
        return true;
    }
