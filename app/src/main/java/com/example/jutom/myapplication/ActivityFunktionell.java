...
public class ActivityFunktionell extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_funktionell);
        ...
        ft.add(R.id.funktFrame, new FragmentFunktionell());
        ft.commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_funktionell, menu);
        return true;
    }
