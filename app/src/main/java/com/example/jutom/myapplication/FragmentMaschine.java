...
public class FragmentMaschine extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        untererRueckenFragment= new UebungFragment(new UebungListAdapter(this.getContext(),SQLHelper.getMaschineuntererRueckens()));
        bauchFragment = new UebungFragment(new ListAdapterBauch(this.getContext(),SQLHelper.getMaschinebauches()));
        tricepFragment = new UebungFragment(new ListAdapterTricep(this.getContext(),SQLHelper.getMaschinetriceps()));
        bicepFragment = new UebungFragment(new ListAdapterBicep(this.getContext(),SQLHelper.getMaschinebiceps()));
        schulterFragment = new UebungFragment(new ListAdapterSchulter(this.getContext(),SQLHelper.getMaschineschulters()));
        obererRueckenFragment = new UebungFragment(new ListAdapterObererRuecken(this.getContext(),SQLHelper.getMaschineobererRueckens()));
        rueckenFragment = new UebungFragment(new ListAdapterRuecken(this.getContext(),SQLHelper.getMaschinerueckens()));
        beinFragment= new UebungFragment(new ListAdapterBeine(this.getContext(),SQLHelper.getMaschinebeines()));
        brustFragment = new UebungFragment(new ListAdapterBrust(this.getContext(),SQLHelper.getMaschinebrusts()));
