...
public class ActivityMaschine extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_maschine);
        ...
        ft.add(R.id.maschiFrame, new FragmentMaschine());
        ft.commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_maschine, menu);
        return true;
    }
