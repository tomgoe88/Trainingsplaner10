...
public class FragmentFunktionell extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        untererRueckenFragment= new UebungFragment(new UebungListAdapter(this.getContext(),SQLHelper.getFunktionelluntererRueckens()));
        bauchFragment = new UebungFragment(new ListAdapterBauch(this.getContext(),SQLHelper.getFunktionellbauches()));
        tricepFragment = new UebungFragment(new ListAdapterTricep(this.getContext(),SQLHelper.getFunktionelltriceps()));
        bicepFragment = new UebungFragment(new ListAdapterBicep(this.getContext(),SQLHelper.getFunktionellbiceps()));
        schulterFragment = new UebungFragment(new ListAdapterSchulter(this.getContext(),SQLHelper.getFunktionellschulters()));
        obererRueckenFragment = new UebungFragment(new ListAdapterObererRuecken(this.getContext(),SQLHelper.getFunktionellobererRueckens()));
        rueckenFragment = new UebungFragment(new ListAdapterRuecken(this.getContext(),SQLHelper.getFunktionellrueckens()));
        beinFragment= new UebungFragment(new ListAdapterBeine(this.getContext(),SQLHelper.getFunktionellbeines()));
        brustFragment = new UebungFragment(new ListAdapterBrust(this.getContext(),SQLHelper.getFunktionellbrusts()));
