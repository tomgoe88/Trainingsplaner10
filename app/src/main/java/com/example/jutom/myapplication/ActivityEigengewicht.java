...
public class ActivityEigengewicht extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_eigengewicht);
        ...
        ft.add(R.id.eigenFrame, new FragmentEigengewicht());
        ft.commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_eigengewicht, menu);
        return true;
    }
