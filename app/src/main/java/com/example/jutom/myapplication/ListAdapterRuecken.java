 ...
 */
public class ListAdapterRuecken extends BaseAdapter implements AdapterView.OnItemClickListener {

     List<Ruecken> uebung;
    private FragmentActivity context;
    Trainingsplaner trainingsplaner;
    public ListAdapterRuecken(FragmentActivity con, List<Ruecken> ueb, Trainingsplaner trainingsplaner){
        this.context= con;
        this.uebung=ueb;
